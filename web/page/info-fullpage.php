        ...
        <div class="navbar-fluid" style="padding-left:20px;padding-right:20px;">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="index.php#p2"><i class="fa fa-fw fa-home"></i>个人简介</a></li>
					<li><a href="index.php#p2"><i class="fa fa-fw fa-university"></i>教育背景</a></li>
					<li><a href="index.php#p3"><i class="fa fa-fw fa-flask"></i>科学研究</a></li>
					<!-- <li><a href="info.php"><i class="fa fa-fw fa-tasks"></i>项目实践</a></li> -->
					<li><a href="index.php#p5"><i class="fa fa-fw fa-star"></i>荣誉奖励</a></li>
					<li><a href="index.php#p5"><i class="fa fa-fw fa-book"></i>SCI论文</a></li>
					<li><a href="index.php#p6"><i class="fa fa-fw fa-code"></i>个人技能</a></li>
					<li><a href="index.php#p6"><i class="fa fa-fw fa-phone"></i>联系我</a></li>
