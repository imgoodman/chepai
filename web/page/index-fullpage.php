...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="src/css/main-2.css">
...
<body>
		...
		<div class="navbar-fluid" style="padding-left:20px;padding-right:20px;">
			...
			<div class="navbar-collapse collapse" id="navbar">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#p2"><i class="fa fa-fw fa-home"></i>个人简介</a></li>
					<li><a href="#p2"><i class="fa fa-fw fa-university"></i>教育背景</a></li>
					<li><a href="#p3"><i class="fa fa-fw fa-flask"></i>科学研究</a></li>
					<!-- <li><a href="info.php"><i class="fa fa-fw fa-tasks"></i>项目实践</a></li> -->
					<li><a href="#p5"><i class="fa fa-fw fa-star"></i>荣誉奖励</a></li>
					<li><a href="#p5"><i class="fa fa-fw fa-book"></i>SCI论文</a></li>
					<li><a href="#p6"><i class="fa fa-fw fa-code"></i>个人技能</a></li>
					<li><a href="#p6"><i class="fa fa-fw fa-phone"></i>联系我</a></li>
		...
		<div class="section">
			<div class="container-fluid" id="main_wrapper">
				<div class="row">
					...
					<div class="col-md-6 col-sm-7 text-center user_name">
						<h1>黄  健</h1>
				...
				<div class="row">
					...
					<div class="col-lg-9">
						<div class="row">
							...
							<div class="col-lg-5">
								<a href="http://cer.sagepub.com/content/22/4/291" target="_blank">A part affordance–based approach for detailed design process planning in collaborative environment</a>
							</div>
							<div class="col-lg-1">
								<img src="src/img/partc.png" class="img-responsive">
							</div>
							<div class="col-lg-5">
								<a href="http://pic.sagepub.com/content/early/2015/04/06/0954406215578702.full.pdf+html" target="_blank">An integrated knowledge-based framework for design reuse</a>
							</div>
						</div>
						<div class="row">
							<div class="col-lg-1">
							...
							<div class="col-lg-5">
								<a href="http://www.sciencedirect.com/science/article/pii/S0010448513001450" target="_blank">A part affordance-based approach for capturing detailed design knowledge</a>
							</div>
							<div class="col-lg-1">
								<img src="src/img/AIE.jpg" class="img-responsive">
							</div>
							<div class="col-lg-5">
								<a href="http://journals.cambridge.org/action/displayAbstract?fromPage=online&aid=9049254&fulltextType=RA&fileId=S0890060413000164" target="_blank">Modeling detailed design knowledge based on an Extended Structure-Behavior-Function Model</a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container-fluid text-center" id="footer" style="position:fixed;bottom:0;width:100%; background-color:#2c3e50;">
		<div class="col-md-12">
	...
	<div class="btn btn-primary" style="display:none;position:fixed;right:10px;bottom:10px;">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#fullpage").fullpage({
				sectionsColor:['#3498DB','#34495E','#2ECC71','#9B59B6','#F39C12','#2c3e50'],
				fixedElements:'#header,#footer',
				anchors:['p1','p2','p3','p4','p5','p6'],
				navigation:true,
				navigationPosition:'right',
				navigationTooltips:['头像','个人简介和教育背景','科学研究','项目实践','荣誉奖励和SCI论文','个人技能和联系我'],
